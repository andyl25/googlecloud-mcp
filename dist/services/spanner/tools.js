 ...
 */
async function getDetailedSchemaForQueryGeneration(instanceId, databaseId) {
...
export function registerSpannerTools(server) {
    ...
    server.tool('list-spanner-tables', {
        ...
        try {
            ...
            for (const row of tablesResult) {
                ...
                const columnCount = row.column_count || 0;
    ...
    server.tool('list-spanner-instances', 
    ...
    server.tool('list-spanner-databases', {
    ...
    server.tool('natural-language-spanner-query', {

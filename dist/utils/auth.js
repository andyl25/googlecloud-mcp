 ...
 */
export async function initGoogleAuth(requireAuth = false) {
    ...
    try {
        ...
        if (!process.env.GOOGLE_APPLICATION_CREDENTIALS) {
            if (requireAuth) {
                throw new Error('Google Cloud authentication not configured. Please set GOOGLE_APPLICATION_CREDENTIALS ' +
 ...
 */
export async function setProjectId(projectId) {
